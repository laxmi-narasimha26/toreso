...
import { Mail, Lock, Package, ArrowRight, Eye, EyeOff, User, Building, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const businessTypes = [
    ...
    { value: 'supplier', label: 'Packaging Supplier' },
          ...
          <div className="w-full max-w-2xl space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground mt-2">
                Join thousands of businesses transforming their procurement process
              </p>
            </div>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="space-y-1 pb-4">
                ...
                <CardDescription>
                  Fill in your details to create your Toreso account
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value: 'buyer' | 'supplier') => 
                    ...
                    >
                      <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-muted">
                        ...
                        <Label htmlFor="buyer" className="cursor-pointer flex-1">
                          <div className="font-medium">Buy Packaging</div>
                          <div className="text-sm text-muted-foreground">Procurement teams</div>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 border rounded-lg p-4 cursor-pointer hover:bg-muted">
                        <RadioGroupItem value="supplier" id="supplier" />
                        <Label htmlFor="supplier" className="cursor-pointer flex-1">
                          <div className="font-medium">Sell Packaging</div>
